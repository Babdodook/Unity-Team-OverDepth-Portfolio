...
public class FanaticAnimEvent : BaseMonsterAnimEvent
{
    FanaticController sc_Controller;
    ...
    {
        base.Awake();
        sc_Controller = GetComponentInParent<FanaticController>();
    }
    ...
    public override void EndAttack()
    {
        ...
        sc_Controller.m_isAttack = false;
        sc_Controller.SetMoveType(MoveType.WalkForward);
    ...
    public void RandomEvade()
    {
        ...
        //        sc_Controller.m_evadeType = EvadeType.backward;
        //        break;
        //    case 1: // 왼쪽 회피
        //        m_Animator.SetInteger("Evade", 1);
        //        sc_Controller.m_evadeType = EvadeType.left;
